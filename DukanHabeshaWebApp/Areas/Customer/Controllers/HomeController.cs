    ...
    public class HomeController : Controller
    {
       ...
       private readonly ILogger<HomeController> _logger;
        ...
        public IActionResult Details(ShoppingCart shoppingCart)
        {
           ...
           ShoppingCart cartFromDb = _unitOfWork.ShoppingCart.GetFirstOrDefault(
            ...
            if (cartFromDb == null)
            {
                ...
                TempData["success"] = string.Format("{0} An item has been added to your cart!!!", 
                    _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == claim.Value).ToList().Count +1);
                _unitOfWork.Save();
            ...
            else
            {
                _unitOfWork.ShoppingCart.IncrementCount(cartFromDb, shoppingCart.Count);
                 TempData["success"] = "Items has been added to your cart!!";
                _unitOfWork.Save();
        ...
        public IActionResult GetJewleryCategory()
        {
            ...
            IEnumerable<Product> productList = _unitOfWork.Product.GetAll(includeProperties: "Category,origin");
            productList = productList.Where(u => u.Category.Name.ToUpper().Contains("JEWELLERY"));
            return View(productList);
        ...
        public IActionResult GetHouseDecorationCategory()
        {
            ...
            IEnumerable<Product> productList = _unitOfWork.Product.GetAll(includeProperties: "Category,origin");
            productList = productList.Where(u => u.Category.Name.ToUpper().Contains("HOUSE HOLD ITEMS"));
            return View(productList);
