...
namespace DukanHabeshaWebApp.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPOST()
        {
            ...
            //when order has made in the first place payment status should be pending and same goes with order status

            //these are to create an order header for a user
           ...
           //this is to create order datail for specific user
            ...
            foreach (var cart in shopingCartVM.ListCart)
            {
                OrderDetail orderDetail = new()
                {
                    ...
                    OrderId = shopingCartVM.OrderHeader.Id, //this attribute is already saved in our db , coz of _unitOfWork.OrderHeader.Add(shopingCartVM.OrderHeader); the above from order header _unitOfWork.Save();
            ...
            /* if (applicationUser.CompanyId.GetValueOrDefault() == 0)
             {*/
                ...
                // var domain = "http://localhost:7167/";
        ...
        public IActionResult Plus(int cartId)
        {
            ...
            TempData["success"] = "The item has been added to your cart!!!";                   
            _unitOfWork.Save();
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            if (cart.Count <=1)
            {
                ...
                TempData["success"] = "An item has been removed from your cart!!!";
        ...
        public IActionResult Remove(int cartId)
        {
            var cart = _unitOfWork.ShoppingCart.GetFirstOrDefault(u => u.Id == cartId);
            _unitOfWork.ShoppingCart.Remove(cart);
            TempData["success"] = "An item has been deleted from your cart!!!";
            _unitOfWork.Save();
